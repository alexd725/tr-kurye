...
class CorporateListFragment extends StatefulWidget {
  @override
  CorporateListFragmentState createState() => CorporateListFragmentState();
}

class CorporateListFragmentState extends State<CorporateListFragment> {
  ...
  getUserListApiCall() async {
    appStore.setLoading(true);
    await getAllUserList(type: Coorporate, page: currentPage).then((value) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text("Corporate Users")),
      body: Observer(
        builder: (_) => Stack(
          children: [
            ListView.builder(
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              Row(
                                children: [
                                  Icon(Icons.home_work_outlined, color: primaryColor, size: 20),
                                  SizedBox(width: 8),
                                  Text(mData.tax_office.validate(), style: primaryTextStyle(size: 14)),
                                ],
                              ),
                              SizedBox(height: 16),
                              Row(
                                children: [
                                  Icon(Icons.numbers, color: primaryColor, size: 20),
                                  SizedBox(width: 8),
                                  Text(mData.tax_number.validate(), style: primaryTextStyle(size: 14)),
                                ],
                              ),
                              SizedBox(height: 8),
                              Row(
