...
class DashboardModel {
  ...
  DashboardModel.fromJson(Map<String, dynamic> json) {
    ...
    return DashboardModel(
      recentClient: json['recent_client'] != null ? (json['recent_client'] as List).map((i) => UserModel.fromJson(i)).toList() : null,
      recentDeliveryMan: json['recent_delivery_man'] != null ? (json['recent_delivery_man'] as List).map((i) => UserModel.fromJson(i)).toList() : null,
      recentOrder: json['recent_order'] != null ? (json['recent_order'] as List).map((i) => OrderModel.fromJson(i)).toList() : null,
      todayRegisterUser: json['today_register_user'],
      totalCity: json['total_city'],
      totalClient: json['total_client'],
      totalCountry: json['total_country'],
      ...
      weeklyOrderCount: json['weekly_order_count'] != null ? (json['weekly_order_count'] as List).map((i) => WeeklyDataModel.fromJson(i)).toList() : null,
      userWeeklyCount: json['user_weekly_count'] != null ? (json['user_weekly_count'] as List).map((i) => WeeklyDataModel.fromJson(i)).toList() : null,
      weeklyPaymentReport: json['weekly_payment_report'] != null ? (json['weekly_payment_report'] as List).map((i) => WeeklyDataModel.fromJson(i)).toList() : null,
    );*/
