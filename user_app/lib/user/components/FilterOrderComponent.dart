          ...
          children: [
            ...
            Wrap(
              ...
              children: statusList.map((item) {
                return Chip(
                  backgroundColor: selectedStatus == item
                      ? colorPrimary
                      : Colors.transparent,
                  label: Text(orderStatus(item)),
                  elevation: 0,
                  labelStyle: primaryTextStyle(
                      color: selectedStatus == item ? white : Colors.grey),
                  ...
                  shape: RoundedRectangleBorder(
                    ...
                    side: BorderSide(
                        color:
                            selectedStatus == item ? colorPrimary : borderColor,
              ...
              if (_formKey.currentState!.validate()) {
                ...
                setValue(
                    ...
                    FilterAttributeModel(
                        ...
                        .toJson());
                appStore.setFiltering(selectedStatus != null ||
                    fromDate != null ||
                    toDate != null);
