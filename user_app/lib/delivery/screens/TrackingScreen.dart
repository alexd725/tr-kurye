...
class TrackingScreen extends StatefulWidget {
  ...
  TrackingScreen(
      {required this.orderId, required this.order, required this.latLng});
...
class TrackingScreenState extends State<TrackingScreen> {
  ...
  Future<void> onMapCreated(GoogleMapController cont) async {
    cont.moveCamera(CameraUpdate.newLatLngZoom(
        LatLng(sourceLocation!.latitude, sourceLocation!.longitude), 14));
  }
