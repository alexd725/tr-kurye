class CalculateDistanceModel {
    ...
    CalculateDistanceModel({this.destinationAddresses, this.originAddresses, this.rows, this.status,this.errorMsg});

    factory CalculateDistanceModel.fromJson(Map<String, dynamic> json) {
        return CalculateDistanceModel(
            destinationAddresses: json['destination_addresses'] != null ? new List<String>.from(json['destination_addresses']) : null, 
            originAddresses: json['origin_addresses'] != null ? new List<String>.from(json['origin_addresses']) : null, 
            rows: json['rows'] != null ? (json['rows'] as List).map((i) => Row.fromJson(i)).toList() : null, 
            status: json['status'],
