...
class PaymentSetupScreenState extends State<PaymentSetupScreen> {
  ...
  checkIsUpdate() async {
    var data =
        (getStringListAsync(PAYMENT_GATEWAY_LIST) ?? []).where((element) {
      PaymentGatewayData mData =
          PaymentGatewayData.fromJson(jsonDecode(element));
  ...
  setData() {
    if (isUpdate && paymentGatewayData != null) {
      ...
      secretKeyController.text = paymentGatewayData!.isTest == 1
          ? paymentGatewayData!.testValue!.secretKey ?? ""
          : paymentGatewayData!.liveValue!.secretKey ?? "";
      publishableKeyController.text = paymentGatewayData!.isTest == 1
          ? paymentGatewayData!.testValue!.publishableKey ?? ""
          : paymentGatewayData!.liveValue!.publishableKey ?? "";
      keyIdController.text = paymentGatewayData!.isTest == 1
          ? paymentGatewayData!.testValue!.keyId ?? ""
          : paymentGatewayData!.liveValue!.keyId ?? "";
      secretIdController.text = paymentGatewayData!.isTest == 1
          ? paymentGatewayData!.testValue!.secretId ?? ""
          : paymentGatewayData!.liveValue!.secretId ?? "";
      publicKeyController.text = paymentGatewayData!.isTest == 1
          ? paymentGatewayData!.testValue!.publicKey ?? ""
          : paymentGatewayData!.liveValue!.publicKey ?? "";
      encryptionKeyController.text = paymentGatewayData!.isTest == 1
          ? paymentGatewayData!.testValue!.encryptionKey ?? ""
          : paymentGatewayData!.liveValue!.encryptionKey ?? "";

      tokenizationKeyController.text = paymentGatewayData!.isTest == 1
          ? paymentGatewayData!.testValue!.tokenizationKey ?? ""
          : paymentGatewayData!.liveValue!.tokenizationKey ?? "";
      accessTokenController.text = paymentGatewayData!.isTest == 1
          ? paymentGatewayData!.testValue!.accessToken ?? ""
          : paymentGatewayData!.liveValue!.accessToken ?? "";
      profileIdController.text = paymentGatewayData!.isTest == 1
          ? paymentGatewayData!.testValue!.profileId ?? ""
          : paymentGatewayData!.liveValue!.profileId ?? "";
      serverKeyController.text = paymentGatewayData!.isTest == 1
          ? paymentGatewayData!.testValue!.serverKey ?? ""
          : paymentGatewayData!.liveValue!.serverKey ?? "";
      clientKeyController.text = paymentGatewayData!.isTest == 1
          ? paymentGatewayData!.testValue!.clientKey ?? ""
          : paymentGatewayData!.liveValue!.clientKey ?? "";
      mIDController.text = paymentGatewayData!.isTest == 1
          ? paymentGatewayData!.testValue!.merchantId ?? ""
          : paymentGatewayData!.liveValue!.merchantId ?? "";
      merchantKeyController.text = paymentGatewayData!.isTest == 1
          ? paymentGatewayData!.testValue!.merchantKey ?? ""
          : paymentGatewayData!.liveValue!.merchantKey ?? "";
  ...
  Future<void> savePaymentApiCall() async {
    ...
    if (selectedPaymentType == PAYMENT_TYPE_STRIPE) {
      valRequest = {
        ...
        "publishable_key": publishableKeyController.text
      };
    } else if (selectedPaymentType == PAYMENT_TYPE_RAZORPAY) {
      valRequest = {
        "key_id": keyIdController.text,
      ...
      valRequest = {
        "profile_id": profileIdController.text,
        "server_key": serverKeyController.text,
        "client_key": clientKeyController.text
      };
      ...
      valRequest = {
        "merchant_id": mIDController.text,
        "merchant_key": merchantKeyController.text
      };
    ...
    MultipartRequest multiPartRequest =
        await getMultiPartRequest('paymentgateway-save');

    multiPartRequest.fields['id'] =
        isUpdate ? paymentGatewayData!.id.toString() : "";
  ...
  Widget stripeForm() {
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 8),
        AppTextField(
          controller: sharedPref.getString(USER_TYPE) == DEMO_ADMIN
  ...
  Widget razorPayForm() {
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 8),
        AppTextField(
          controller: getStringAsync(USER_TYPE) == DEMO_ADMIN
              ? TextEditingController()
              : keyIdController,
          textFieldType: TextFieldType.OTHER,
          textInputAction: TextInputAction.next,
                        ...
                        return InkWell(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              color: selectedPaymentType == mData.type
                                  ? primaryColor
                    ...
                    Container(
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text('${getPaymentTitle()} ${language.payment}',
                                style: boldTextStyle(size: 18)),
                            SizedBox(height: 24),
                            Text(language.payment_method,
                            ...
                            if (logoImagePath != null)
                              Center(
                                  child: commonCachedNetworkImage(logoImagePath,
                                      height: 100,
                                      width: 100,
                                      fit: BoxFit.cover)),
                            SizedBox(height: 20),
                            Center(
                              child: commonButton(
                                  isUpdate ? language.update : language.save,
                                  () {
                                  ...
                                  if (_formKey.currentState!.validate()) {
                                    if (isTest == null)
                                      return toast(language
                                          .please_select_payment_gateway_mode);
                                    savePaymentApiCall();
                                  }
                                }
                              }, width: 200),
