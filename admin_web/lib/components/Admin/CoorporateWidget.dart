...
import 'package:local_delivery_admin/components/Admin/BodyCornerWidget.dart';
import 'package:local_delivery_admin/components/CommonConfirmationDialog.dart';
import 'package:local_delivery_admin/components/PaginationWidget.dart';
import '/../main.dart';
...
import 'package:local_delivery_admin/utils/Extensions/constants.dart';
import '../../utils/Extensions/text_styles.dart';

class CoorporateWidget extends StatefulWidget {
  static String route = '/admin/Coorporate';
  @override
  CoorporateWidgetState createState() => CoorporateWidgetState();
}

class CoorporateWidgetState extends State<CoorporateWidget> {
  ...
  getUserListApiCall() async {
    appStore.setLoading(true);
    await getAllUserList(type: Coorporate, page: currentPage, perPage: perPage)
        .then((value) {
                    ...
                    userData.isNotEmpty
                        ? Column(
                            ...
                            children: [
                                    ...
                                    child: ConstrainedBox(
                                      ...
                                      child: DataTable(
                                        ...
                                        columns: [
                                          ...
                                          DataColumn(label: Text("Tax Office")),
                                        ...
                                        rows: userData.map((e) {
                                          return DataRow(cells: [
                                            ...
                                            DataCell(Text(e.tax_number ?? "-")),
                                            DataCell(Text(e.tax_office ?? "-")),
                              ...
                              //                     DataColumn(
                              //                         label: Text(language.register_date)),
